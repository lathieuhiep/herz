...
class herz_recent_post_widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        $widget_ops = array(
            'classname'     =>  'herz_recent_post_widget',
            'description'   =>  esc_html__( 'A widget show post', 'herz' ),
        );

        parent::__construct( 'herz_recent_post_widget', 'Basic Theme: Recent Post', $widget_ops );
        ...
        <p>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'select_cat' ) ) . '[]'; ?>" class="widefat" size="10" multiple>
                ...
                <option value="0" <?php echo ( in_array( 0, $select_cat ) ? 'selected="selected"' : '' ); ?>>
                    <?php esc_html_e( 'All Category', 'herz' ); ?>
                </option>
...
// Register widget
function herz_recent_post_widget_register() {
    register_widget( 'herz_recent_post_widget' );
}

add_action( 'widgets_init', 'herz_recent_post_widget_register' );