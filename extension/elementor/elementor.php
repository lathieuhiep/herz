...
final class herz_plugin_elementor_widgets {
    ...
    public function init_category() {
        ...
        Plugin::instance()->elements_manager->add_category(
            'herz_widgets',
            [
                'title' => esc_html__( 'Basic Theme Widgets', 'herz' ),
                'icon'  => 'icon-goes-here'
            ]
        );
    ...
    public function init_script() {
        wp_register_script( 'herz-elementor-custom', get_theme_file_uri( '/js/elementor-custom.js' ), array(), '1.0.0', true );
    }

}

herz_plugin_elementor_widgets::instance();