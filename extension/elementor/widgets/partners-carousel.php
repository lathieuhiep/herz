...
class herz_widget_partners_carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'herz-partners-carousel';
    }

    public function get_title() {
        return esc_html__( 'Partners Carousel', 'herz' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' =>  esc_html__( 'Partners Carousel', 'herz' )
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new herz_widget_partners_carousel );